...
(function (Drupal, once) {
  ...
  function checkIfDesktopNavigationWraps(entries) {
    ...
    if (Drupal.smeal.isDesktopNav() && entries[0].contentRect.height > navItem.clientHeight) {
  ...
  Drupal.behaviors.automaticMobileNav = {
    attach: function attach(context) {
      once('smeal-automatic-mobile-nav', '[data-drupal-selector="primary-nav-menu--level-1"]', context).forEach(init);
    }
  };
})(Drupal, once);