...
((Drupal) => {
  const { isDesktopNav } = Drupal.smeal;
  ...
  Drupal.smeal.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.smeal.isDesktopNav()) return;
  ...
  Drupal.smeal.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.smeal.areAnySubNavsOpen = areAnySubNavsOpen;
