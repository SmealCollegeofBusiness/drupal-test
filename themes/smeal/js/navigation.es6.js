...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.smeal.areAnySubNavsOpen()) {
          props.smeal.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.smealNavigation = {
    attach(context) {
